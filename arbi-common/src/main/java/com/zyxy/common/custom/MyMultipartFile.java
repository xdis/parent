...
public class MyMultipartFile implements MultipartFile {
    ...
    /**
     * Create a new MyMultipartFile with the given content.
     * @param name the name of the file
     * @param fileOrignName the file orign name
     * @param content the content of the file
     */
    public MyMultipartFile(String name, String fileOrignName, byte[] content) {
        this(name, fileOrignName, null, content);
    }
