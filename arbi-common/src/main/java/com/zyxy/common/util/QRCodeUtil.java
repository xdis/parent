...
public class QRCodeUtil {
    ...
    public static byte[] encode(String content, InputStream logo) {
        BufferedImage image = null;
        ByteArrayOutputStream output = null;
        try {
            image = QRCodeUtil.createImage(content, logo);
    ...
    public static byte[] encode(String content) {
        ...
        ByteArrayOutputStream output = null;
        try {
            image = QRCodeUtil.createImage(content, null);
            output = new ByteArrayOutputStream();
            ImageIO.write(image, FORMAT_NAME, output);
        } catch (Exception e) {
            logger.error("生成二维码失败", e);
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(ImageUtil.convertImg2Base64(QRCodeUtil.encode("https//tqblog.cn")));
    }
}
