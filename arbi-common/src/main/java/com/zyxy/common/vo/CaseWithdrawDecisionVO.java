 ...
 *   撤案决定书VO
 */
@ApiModel(value ="撤案决定书VO")
public class CaseWithdrawDecisionVO {
    /**
     * 文书号年份
     */
    @ApiModelProperty("文书号年份")
    private String docYear;

    /**
     * 文书号序号
     */
    @ApiModelProperty("文书号序号")
    private String docNo;

    /**
     * 文书正文
     */
    @ApiModelProperty("文书正文")
    private String docContent;

    /**
     * 文书决定
     */
    @ApiModelProperty("文书决定")
    private String docFinalDecision;
     ...
     * 文书仲裁员
     */
    @ApiModelProperty("文书仲裁员")
    private String docArbitrator;

    /**
     * 仲裁员名称
     */
    @ApiModelProperty("仲裁员名称")
    private String docSecretary;
    ...
    public String getDocFinalDecision() {
        return docFinalDecision;
    }

    public void setDocFinalDecision(String docFinalDecision) {
        this.docFinalDecision = docFinalDecision;
    }
    ...
    public String getDocArbitrator() {
        return docArbitrator;
    }

    public void setDocArbitrator(String docArbitrator) {
        this.docArbitrator = docArbitrator;
    }

    public String getDocSecretary() {
        return docSecretary;
    }

    public void setDocSecretary(String docSecretary) {
        this.docSecretary = docSecretary;
    }
