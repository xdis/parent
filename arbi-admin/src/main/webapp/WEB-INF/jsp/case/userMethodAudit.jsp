 ...
 */
    ...
    $('#caseList').bootstrapTable({
        method: 'post',
        url:"${appCtx}/method/audit/list",//要请求数据的文件路径
    ...
    function cardImageCon(value,row,index){
 	...
 	//  驳回名字显示为红色
    function certName(value,row,index){
    	var msg=row.status;
    	var name=row.certName;
    	if(msg=='2'){
    ...
    $('#search_btn').click(function(){
       $('#caseList').bootstrapTable('refresh', {url: '${appCtx}/method/audit/list'});
    });
