...
(function ($, win, undef) {
    ...
    var Validform = function (forms, settings, inited) {
        ...
        forms.each(function () {
            ...
            //bind the blur event;
            //注释开始----2016年9月19日14:35:33  luyj
            //$this.delegate("[datatype]", "blur", function () {
            //    //判断是否是在提交表单操作时触发的验证请求；
            //    var subpost = arguments[1];
            //    Validform.util.check.call(this, $this, subpost);
            //});
            //注释结束----2016年9月19日14:35:33  luyj
    ...
    Validform.util = {
        ...
        _regcheck: function (datatype, gets, obj, curform) {
            ...
            if (passed) {
                ...
                if (Validform.util.isEmpty.call(obj, gets)) {
                    info = obj.attr("nullmsg") || tipmsg.nullmsg[obj.attr("datatype")] || Validform.util.getNullmsg.call(obj, curform);
                }
            }
        ...
        check: function (curform, subpost, bool) {
            ...
            //不是在提交表单时触发的ajax验证;
            //注释开始----2016年9月19日15:23:55  luyj
            //if (inputval == this.validform_lastval && !$(this).attr("recheck") && subpost == "") {
            //    return flag.passed ? true : false;
            //}
            //注释结束----2016年9月19日15:24:00  luyj
    ...
    Validform.prototype = {
        ...
        check: function (bool, selector) {
            ...
            curform.find(selector).each(function () {
                flag=Validform.util.check.call(this, curform, "", bool);
                //修改开始----2016-12-30 19:29:17  luyj
                if(!flag)return false;
                //修改开始----2016-12-30 19:29:17  luyj
                //注释开始----2016-12-30 19:29:17  luyj
                //Validform.util.check.call(this, curform, "", bool) || (flag = false);
                //注释结束----2016-12-30 19:29:17  luyj
            });
